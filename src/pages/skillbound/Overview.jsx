        ...
        <div className="space-y-10">
            ...
            <section className="space-y-6">
                <div className="space-y-2">
                    <h2 className="text-2xl font-semibold text-reef-gold-100">Core Systems</h2>
                    <p className="text-reef-gold-200">
                        Explore the key systems that make SkillBound 2.5D a complete platformer solution.
                    </p>
                </div>
